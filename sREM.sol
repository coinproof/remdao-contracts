...
contract sReincarnate is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Reincarnate", "sREM", 9) ERC20Permit() {
    ...
    /**
        @notice allows pools to be blocked from receiving, but not sending, sREM
    ...
    /**
        @notice increases sREM supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sREM
